...
OPS = {
  ...
  'max_pool_3x3' : lambda C, stride, affine, edge: nn.MaxPool2d(3, stride=stride, padding=1),
  'avg_pool_3x3' : lambda C, stride, affine, edge: nn.AvgPool2d(3, stride=stride, padding=1, count_include_pad=False),
